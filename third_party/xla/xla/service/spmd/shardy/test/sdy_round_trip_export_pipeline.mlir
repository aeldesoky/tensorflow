...
// CHECK-V2-SAME:      %arg0: tensor<8x8xf32> {mhlo.frontend_attributes = {xla.sdy.sharding = "#sdy.sharding<@mesh_1, [{}, {}], unreduced=max{\22x\22}>"}, mhlo.sharding = "{devices=[1,1,8,4]<=[32] last_tile_dims={unreduced, replicated}}"},
// CHECK-V3-SAME:      %arg0: tensor<8x8xf32> {mhlo.sharding = "{mesh['x'=8,'y'=4], [{}, {}], unreduced=max{'x'}}"},
// CHECK-V2-SAME:      %arg1: tensor<8x8xf32> {mhlo.frontend_attributes = {xla.sdy.sharding = "#sdy.sharding<@mesh_1, [{}, {}], unreduced=min{\22x\22}>"}, mhlo.sharding = "{devices=[1,1,8,4]<=[32] last_tile_dims={unreduced, replicated}}"}
